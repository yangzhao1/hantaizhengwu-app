 ...
 *
 * <p>Here is a simple example of using a FragmentTabHost in an LoginActivity:
 *
    ...
    public void addTab(@NonNull TabSpec tabSpec, @NonNull Class<?> clss,
        ...
        if (mAttached) {
            ...
            if (info.fragment != null && !info.fragment.isDetached()) {
                ...
                ft.replace(android.R.id.tabcontent,info.fragment);
        ...
        for (int i = 0, count = mTabs.size(); i < count; i++) {
            ...
            if (tab.fragment != null) {
                if (tab.tag.equals(currentTag)) {
                    ...
                    ft.replace(android.R.id.tabcontent,tab.fragment);
