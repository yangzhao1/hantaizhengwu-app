...
public class MyCollectionActivity extends BaseActivity implements IRefreshUI {
    ...
    protected void initData() {
        ...
        controller.postData(MyFacesUrl.collCetFind,map);
    }
        ...
        try {
            ...
            if (code.equals("200")) {
                ...
                for (int i = 0; i < data.length(); i++) {
                    ...
                    thingListBean.setId(data.getJSONObject(i).getString("itemId"));
